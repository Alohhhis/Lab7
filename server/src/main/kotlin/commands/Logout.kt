...
import commands.StorageCommand
import data.Messages

/**
 * The LogoutCommand class handles the process of user logout.
 *
 * @property usersStorage The collection of users where the current logged-in user will be logged out.
 */
class Logout : StorageCommand() {
