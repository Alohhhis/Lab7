 ...
 */
class UsersStorage : KoinComponent {
    ...
    private fun executeUpdate(query: String, vararg parameters: Any?): Boolean {
        ...
        return try {
            ...
            println("Ошибка при выполнении обновления SQL: ${ex.message}")
            false
        }
    }
    ...
    private fun generateToken(username: String): String {
        ...
        return "Успешный вход, пупупуууу, ваш токен: $token"
    }
    ...
    fun validateToken(token: String): String? {
        ...
        return try {
            ...
            println("Ошибка во время валидации токена: ${e.message}")
            null
        }
    }
}
